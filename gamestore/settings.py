...
CLOUDINARY_STORAGE = {
    ...
    "API_SECRET": os.environ.get("CLOUDINARY_API_SECRET", "VEgWXoTVsgZ9L3-sPmtHMIVJ1QM"),
}
...
#API TELEGRAM
TELEGRAM_BOT_TOKEN = os.getenv("8785011131:AAGqyG3WxXpgWo2WuMvALKl5pzK5gtTAx7U"),
TELEGRAM_CHAT_ID = os.getenv("TELEGRAM_CHAT_ID", "-5515982895"),